...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="#">Collaborateurs <span class="sr-only">cc</span></a>
        </li>
        <li class="nav-item">
...
<div class="row">
    ...
    <div class="col align-self-end">
        <a href="ajoutCollaborateur.html">
        <button type="button" class="btn btn-light">Ajouter un nouveau collaborateur</button>
        </a>
    </div>
</div>
...
<form>
    ...
    <div class="form-row">
        <div class="form-group col-4">
            <label class="mr-sm-2" for="inlineFormCustomSelect">Filtrer par departement</label>
        </div>
...
<div class="card-columns">
    <div class="card" >
            <img class="card-img-top" src="https://cdnfr1.img.sputniknews.com/images/102884/15/1028841504.jpg" alt="Card image cap">
        <div class="card-body">
            <h5 class="card-title">Nom Prenom</h5>
            <h6 class="card-subtitle mb-2 text-muted">fonction</h6>
            <p class="card-text">Département : 60<br /> Email : salut@coucou.fr  <br />  Telephone : 0601020304</p>
